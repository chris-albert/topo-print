  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-6">About Topo Print</h1>
        ...
        <div className="space-y-4 text-gray-600">
          ...
          <h2 className="text-xl font-semibold text-gray-900 pt-4">Data Sources</h2>
          ...
          <h2 className="text-xl font-semibold text-gray-900 pt-4">Limitations</h2>
          <ul className="list-disc list-inside space-y-2">
          ...
          <h2 className="text-xl font-semibold text-gray-900 pt-4">Print Tips</h2>
          <ul className="list-disc list-inside space-y-2">
